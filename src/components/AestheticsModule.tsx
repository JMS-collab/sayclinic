...
const PRESET_PROCEDURES: {
...
}[] = [
  {
    ...
    vectors: [
      // ČELO (m. frontalis) - Horný rad
      {
        id: 'dys_f1',
        type: 'point',
        view: 'front',
        color: '#3B82F6',
        startPoint: { x: 220, y: 175 },
      ...
      // ČELO - Dolný bezpečnostný rad
      {
        id: 'dys_f5',
        type: 'point',
        view: 'front',
        color: '#3B82F6',
        startPoint: { x: 255, y: 215 },
  ...
  },
  {
    ...
    vectors: [
      ...
      },
      {
        ...
        view: 'front',
        color: '#D97706',
        startPoint: { x: 190, y: 340 },
        endPoint: { x: 255, y: 365 },
        fanningRays: [
          { x: 255, y: 340 },
          { x: 265, y: 360 },
          { x: 260, y: 385 },
      ...
      },
      {
        ...
        view: 'front',
        color: '#D97706',
        startPoint: { x: 408, y: 340 },
        endPoint: { x: 342, y: 365 },
        fanningRays: [
          { x: 342, y: 340 },
          { x: 332, y: 360 },
          { x: 338, y: 385 },
    ...
    vectors: [
      {
        ...
        view: 'front',
        color: '#C5A059',
        startPoint: { x: 190, y: 335 },
        endPoint: { x: 260, y: 390 },
        fanningRays: [
          { x: 260, y: 345 },
          { x: 268, y: 370 },
          { x: 262, y: 395 },
      ...
      },
      {
        ...
        view: 'front',
        color: '#C5A059',
        startPoint: { x: 408, y: 335 },
        endPoint: { x: 338, y: 390 },
        fanningRays: [
          { x: 338, y: 345 },
          { x: 330, y: 370 },
          { x: 335, y: 395 },
...
export function AestheticsModule({ 
  ...
  const countFreehand = vectors.filter(v => v.type === 'freehand').length;
